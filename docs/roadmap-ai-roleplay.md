...
| Qwen Base 多情绪参考 prompt + CosyVoice 流式情绪 | 3.3 | 0.2.21 已落 CosyVoice provider PCM 传输层；仍依赖统一 `SpeechStyle`、真实账号 PCM/TTFA 验证和音频 A/B 基准，复刻音色优先 | 低 | `- [~]` 🔧 传输层测试版（0.2.21） |
